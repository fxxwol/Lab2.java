    ...
    public static University createUniversity() {
        ...
        groups.get(0).setSubjects(new ArrayList<>(List.of(
                new Subject("Data Analyse", "Stepan Dumych", new HashMap<>() {{
                    put(groups.get(0).getStudents().get(0), List.of(30));
                    put(groups.get(0).getStudents().get(1), List.of(45));
                    put(groups.get(0).getStudents().get(2), List.of(40));
                }},
                        new ArrayList<>(List.of(LocalDate.of(2022, 9, 6),
                                LocalDate.of(2022, 9, 9)))),
                new Subject("Collecting data", "Vitalina Baksa", new HashMap<>() {{
                    put(groups.get(0).getStudents().get(0), List.of(78));
                    put(groups.get(0).getStudents().get(1), List.of(61));
                    put(groups.get(0).getStudents().get(2), List.of(57));
                }},
                        new ArrayList<>(List.of(LocalDate.of(2022, 9, 7),
                                LocalDate.of(2022, 9, 9)))),
                new Subject("Physical Education", "Stepan Festryha", new HashMap<>() {{
                    put(groups.get(0).getStudents().get(0), List.of(88));
                    put(groups.get(0).getStudents().get(1), List.of(67));
                    put(groups.get(0).getStudents().get(2), List.of(91));
                }},
        ...
        groups.get(1).setSubjects(new ArrayList<>(List.of(
                new Subject("Information systems and technologies", "Orest Kostiv", new HashMap<>() {{
                    put(groups.get(1).getStudents().get(0), List.of(61));
                    put(groups.get(1).getStudents().get(1), List.of(70));
                }},
                        new ArrayList<>(List.of(LocalDate.of(2022, 9, 6),
                                LocalDate.of(2022, 9, 9)))),
                new Subject("Physics", "Oleksandr Kolomiets", new HashMap<>() {{
                    put(groups.get(1).getStudents().get(0), List.of(65));
                    put(groups.get(1).getStudents().get(1), List.of(56));
                }},
                        new ArrayList<>(List.of(LocalDate.of(2022, 9, 6),
                                LocalDate.of(2022, 9, 9))))
        )));
        groups.get(2).setSubjects(new ArrayList<>(List.of(
                new Subject("Team Work", "Viktor Hryhorovych", new HashMap<>() {{
                    put(groups.get(2).getStudents().get(0), List.of(88));
                    put(groups.get(2).getStudents().get(1), List.of(91));
                    put(groups.get(2).getStudents().get(2), List.of(100));
                }},
                        new ArrayList<>(List.of(LocalDate.of(2022, 9, 6),
                                LocalDate.of(2022, 9, 9)))),
                new Subject("Physical Education", "Stepan Festryha", new HashMap<>() {{
                    put(groups.get(2).getStudents().get(0), List.of(65));
                    put(groups.get(2).getStudents().get(1), List.of(56));
                    put(groups.get(2).getStudents().get(2), List.of(87));
                }},
                        new ArrayList<>(List.of(LocalDate.of(2022, 9, 6),
                                LocalDate.of(2022, 9, 9))))
        )));
