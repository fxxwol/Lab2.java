...
public class Main {
    public static List<Group> createGroupsAndSchedule(){
        ...
        groups.get(0).setSubjects(new ArrayList<>(List.of(
                new Subject("Data Analyse", "Stepan Dumych", new HashMap<Student, Integer>(){{
                ...
                new Subject("Collecting data", "Vitalina Baksa", new HashMap<Student, Integer>(){{
                    ...
                    put(groups.get(0).getStudents().get(2), 57); }},
                        new ArrayList<>(List.of(LocalDate.of(2022, 9, 7),
                                LocalDate.of(2022, 9, 9)))),
                new Subject("Physical Education", "Stepan Festryha", new HashMap<Student, Integer>(){{
        ...
        groups.get(1).setSubjects(new ArrayList<>(List.of(
                new Subject("Information systems and technologies", "Orest Kostiv", new HashMap<Student, Integer>(){{
                    put(groups.get(1).getStudents().get(0), 61);
                    put(groups.get(1).getStudents().get(1), 70);}},
                        new ArrayList<>(List.of(LocalDate.of(2022, 9, 6),
                                LocalDate.of(2022, 9, 9)))),
                new Subject("Physics", "Oleksandr Kolomiets", new HashMap<Student, Integer>(){{
        ...
        groups.get(2).setSubjects(new ArrayList<>(List.of(
                new Subject("Team Work", "Viktor Hryhorovych", new HashMap<Student, Integer>(){{
    ...
    public static void main(final String[] args) {
        final List<Group> groups = createGroupsAndSchedule();
        final University university = new University("Lviv Polytechnic National University", groups);
